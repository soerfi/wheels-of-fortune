...
- **Backend Anti-Abuse (Strict Limits):** Um massenhaftes Spammen von Gutscheinen zu verhindern, gibt es ein Serverseitiges Rate-Limit (max. 2 Drehs pro Stunde pro IP) und einen 1-Gewinn-pro-E-Mail-Adresse Check in `/api/winners`. Die Fehlermeldungen sind spielerfreundlich formatiert ("Du hast bereits...").
