...
if 'const defaultDesc' not in new_content:
    new_content = new_content.replace('const buttonText: any =', default_desc + '\n          const buttonText: any =')
...
print("Updates applied successfully." if updated_translations else "Failed to find translations")
