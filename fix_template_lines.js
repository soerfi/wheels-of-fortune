...
const newTemplate = `                <div style="background-color: #f4f4f5; padding: 40px 0;">
...
// Replace lines 637-699 (0-indexed 636-698)
const before = lines.slice(0, 637);
const after = lines.slice(699);
